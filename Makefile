...
.PHONY: linux-amd64
linux-amd64:
	@echo Build mirco_gateway [linux-amd64] CGO_ENABLED=$(CGO_ENABLED)
...
.PHONY: darwin-amd64
darwin-amd64:
	@echo Build mirco_gateway [darwin-amd64] CGO_ENABLED=$(CGO_ENABLED)
...
.PHONY: darwin-arm64
darwin-arm64:
	@echo Build mirco_gateway [darwin-arm64] CGO_ENABLED=$(CGO_ENABLED)
